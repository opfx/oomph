...
:CASE_INSTALL
	...
	echo on
	start ..\..\setup\eclipse-inst.exe -vmargs -Dopts.install.root="%INSTALLPATH%" -Duser.home="%USERPROFILE%" -Doomph.redirection.setups="http://git.eclipse.org/c/oomph/org.eclipse.oomph.git/plain/setups/->%setups%"
